...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{ route('dashboard.index') }}" class="logo">
            ...
            <span class="logo-mini"><b>F</b>akaa</span>
            <span class="logo-lg"><b>Fakka</b></span>
...
<br>
    ...
    <footer class="main-footer">
             <div class="footer-copyright text-center py-3">© 2020-2021 Copyright:
                <a target="_blank"href="https://transglobal.com.eg/"> TransGlobal Company</a>
            </div>
    </footer>
