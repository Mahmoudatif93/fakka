...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <h1>@lang('site.wallet')</h1>

        <ol class="breadcrumb">
            <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> @lang('site.dashboard')</a></li>
            <li class="active">@lang('site.wallet')</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <div class="box-header with-border">
                ...
                <h3 class="box-title" style="margin-bottom: 15px">@lang('site.wallet') <small>{{ $clients->total() }}</small></h3>

                <form action="{{ route('dashboard.wallet.index') }}" method="get">
                ...
                <table class="table table-hover">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th>@lang('site.transaction_numb')</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $client->unitamount}}</td>
                            <td>{{ $client->currency}}</td>
                            <td>{{ $client->bank_name}}</td>
                            <td>{{ $client->transaction_number }}</td>
                            ...
                            <td>
                                ...
                                <form action="{{ route('dashboard.wallet.approve', $client->id) }}" method="post" style="display: inline-block">
                                    {{ csrf_field() }}
                                    {{ method_field('post') }}
                                    <button type="submit" class="btn btn-success"> @lang('site.wallet')</button>
                                </form><!-- end of form -->
                                ...
                                <form action="{{ route('dashboard.wallet.destroy', $client->id) }}" method="post" style="display: inline-block">
                                    {{ csrf_field() }}
                                    {{ method_field('delete') }}
