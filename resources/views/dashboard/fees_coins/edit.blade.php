        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.coins_fees.update', $category->id) }}" method="post">
                        ...
                        <div class="row ">
                            <div class=" col-md-12">
                                <div class="form-group col-md-4">
                                        ...
                                        <select   readonly name="coins_id" class="form-control">
                                           
                                            @foreach ($ingots as $ingot)
                                            <option readonly  value="{{ $ingot->id }}" {{ $category->ingots_id == $ingot->id ? 'selected' : '' }}>{{ $ingot->coins }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group col-md-4">
