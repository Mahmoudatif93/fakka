                    ...
                    @if ($products->count() > 0)
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <th>@lang('site.ProductID')</th>
                                <th>@lang('site.category')</th>
                                <th>@lang('site.image')</th>
                                <th>@lang('site.number_grams')</th>
                                <!--<th>@lang('site.thickness(mm)')</th>-->
                                <th>@lang('site.karat')k(Gold)</th>
                                <th>@lang('site.Weight')(Gram)</th>
                                <th>@lang('site.manufacturer')</th>
                                <th>@lang('site.design')</th>
                                 <!--<th>@lang('site.diameter(mm)')</th>-->
                            ...
                            @foreach ($products as $index=>$product)
                                <tr>
                                    ...
                                    <td>{{ $product->number_grams }}</td>
                                    <!-- <td>{{ $product->thickness }}</td>-->
                                    <td>{{ $product->karat }}k(Gold) </td>
