...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <h1>@lang('site.withdrow_wallet')</h1>

        <ol class="breadcrumb">
            <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> @lang('site.dashboard')</a></li>
            <li class="active">@lang('site.withdrow_wallet')</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <div class="box-header with-border">
                ...
                <h3 class="box-title" style="margin-bottom: 15px">@lang('site.withdrow_wallet') <small>{{ $clients->total() }}</small></h3>

                <form action="{{ route('dashboard.withdrowwallet.index') }}" method="get">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('dashboard.withdrowwallet.approve', $client->id) }}" method="post" style="display: inline-block">
                                    {{ csrf_field() }}
                                    {{ method_field('post') }}
                                    <button type="submit" class="btn btn-success"> @lang('site.withdrow_wallet')</button>
                                </form><!-- end of form -->
                                ...
                                <form action="{{ route('dashboard.withdrowwallet.destroy', $client->id) }}" method="post" style="display: inline-block">
                                    {{ csrf_field() }}
                                    {{ method_field('delete') }}
