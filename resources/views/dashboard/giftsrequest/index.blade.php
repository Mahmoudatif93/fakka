...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <h1>@lang('site.giftsrequest')</h1>

        <ol class="breadcrumb">
            <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> @lang('site.dashboard')</a></li>
            <li class="active">@lang('site.giftsrequest')</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <div class="box-header with-border">
                ...
                <h3 class="box-title" style="margin-bottom: 15px">@lang('site.giftsrequest') <small>{{ $clients->total() }}</small></h3>

                <form action="{{ route('dashboard.giftsrequest.index') }}" method="get">
            ...
            <div class="box-body">
                ...
                <table class="table table-hover">
                    ...
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>@lang('site.gift_points')</th>
                            <th>@lang('site.gift_name')</th>
                            <th>@lang('site.gift_image')</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $index + 1 }}</td>
                            <td>{{ $client->Gifts->gift_points }}</td>
                            <td>{{ $client->Gifts->gift_name }}</td>
                      
                            <td><img src="{{ asset('uploads/gifts/' . $client->Gifts->gift_image) }}" style="width: 100px"  class="img-thumbnail" alt=""></td>
                            ...
                            <td>
                                ...
                                <form action="{{ route('dashboard.giftsrequest.approve', $client->id) }}" method="post" style="display: inline-block">
                                    {{ csrf_field() }}
                                    {{ method_field('post') }}
                                    <button type="submit" class="btn btn-success"> approve @lang('site.giftsrequest')</button>
                                </form><!-- end of form -->
                                ...
                                <form action="{{ route('dashboard.giftsrequest.destroy', $client->id) }}" method="post" style="display: inline-block">
                                    {{ csrf_field() }}
                                    {{ method_field('delete') }}
