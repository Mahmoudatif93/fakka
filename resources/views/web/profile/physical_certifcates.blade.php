                        ...
                        <div class="item">
                            ...
                            <div class="certification-info">
                                <div class="certification-head">
                                    ...
                                    <input class="input" type="text" value="   {{$virtualpaymenthistory->unite_weight * $virtualpaymenthistory->amount }}  grams gold 24K" readonly>
                                </div>
                        ...
                        <div class="right-side">
                            <div>
                                ...
                                <div class="certification">
                                    ...
                                    <div class="item-info">
                                        <h4>
                                          {{$virtualpaymenthistory->unite_weight * $virtualpaymenthistory->amount }} gram BTC Gold 24k
                                        </h4>
                                        <span>
                                ...
                                <div class="buttons">
                                    <a href="{{ route('fakka.physical_downloadPDF',$virtualpaymenthistory->id) }}"  class="btn outline-btn download">
                                        <figure>
                                            <img src="{{ asset('web_files/images/download.svg') }} " alt="">
                                        </figure>
                                        Download</a>
                                    <a href="{{ route('fakka.physical_printcertifcates',$virtualpaymenthistory->id) }}" target="_blank"  class="btn outline-btn print">
                                        <figure>
